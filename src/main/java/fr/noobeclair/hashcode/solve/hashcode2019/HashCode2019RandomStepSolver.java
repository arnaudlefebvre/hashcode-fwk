...
public class HashCode2019RandomStepSolver extends Solver<HashCode2019BeanContainer> {
    ...
    private class Step1 extends AbstractStep<HashCode2019BeanContainer> {
        ...
        protected HashCode2019BeanContainer runStep(final HashCode2019BeanContainer datas) {
            final List<Photo> listPhotosVertical = datas.getPhotos().stream().filter(photo -> photo.getSens().equalsIgnoreCase("V"))
    ...
    private class Step4 extends AbstractStep<HashCode2019BeanContainer> {
        ...
        protected HashCode2019BeanContainer runStep(final HashCode2019BeanContainer datas) {
            ...
            int i = 1;
            final int j = datas.getSlides().size();
            final ProgressBar bar = new ProgressBar(j, 100, "|", "|", "=", "=>", "Done!");
