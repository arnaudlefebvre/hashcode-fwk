...
public class CarDiscoveryConfig {
	...
	public CarDiscoveryConfig(Double coefBonus, Double nearBonus, Double distanceBonus) {
		super();
	...
	public CarDiscoveryConfig(Double timeToFinishCoef, AdjustMethod nearTravelAdjustFct, AdjustMethod nearDistAdjustFct, AdjustMethod longTravelAdjustFct, AdjustMethod longDistAdjustFct,
	...
	public String toString() {
		...
		builder.append("CarDiscoveryConfig [timeToFinishCoef=");
